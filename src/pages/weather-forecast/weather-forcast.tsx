...
const WeatherForcast = () => {
    const [userLocation, setUserLocation] = useState("Long beach")
      ...
      <Container maxWidth="xl">
        {
          ...
          : (
            <Box sx={{width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid black"}}>
              <CircularProgress sx={{minHeight: "100px", maxHeight: "250px"}} />
            </Box>
          )
        }
